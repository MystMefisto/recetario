...
<body>
    <div id="app">
        <nav class="navbar-color navbar navbar-expand-md navbar-light bg-primary shadow-sm">
            <div class="container">
                <div class="container mt-1">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img class="iconlogo" src="/images/coffee.svg" alt="">
                    <p class="text-logo">Café Rockstar</p>
                </a>
            </div>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <img class="rounded-circle" style="height:45px" src="/storage/{{ Auth::user()->perfil->imagen }}" alt="">
                                </a>
